...
REM 1. Detectar el directorio de trabajo del script
set "ROOT_DIR=%~dp0"
cd /d "%ROOT_DIR%"

echo [*] Directorio de trabajo establecido: %CD%

REM Generar accesos directos con iconos en el directorio padre si no existen
...
REM Si no existe la carpeta .git un nivel arriba (la raiz del proyecto)
if exist "..\.git" goto :git_repo_ok
